...
import jobs.vibehunt.models.EmployerDashboardDto
import jobs.vibehunt.models.SeekerDashboardDto
import jobs.vibehunt.models.SeekerDesiredPositionsResponse
import jobs.vibehunt.models.SeekerSkillsResponse
...
class EmployerProfileService(
    ...
    fun createJobProfile(userId: UUID, request: jobs.vibehunt.models.CreateJobProfileRequest): jobs.vibehunt.models.JobProfileDto {
    ...
    fun updateJobProfile(userId: UUID, jobProfileId: Long, request: jobs.vibehunt.models.UpdateJobProfileRequest) {
        referenceRepository.findOccupationById(request.occupationId)
            ?: error("Должность не найдена")
